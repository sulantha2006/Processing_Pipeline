...
defaultVersioningForStudy = dict(ADNI={'T1': 'V1', 'AV45': 'V1', 'FDG': 'V1', 'FMRI': 'V1', 'BLUFF': 'V1', 'AV1451': 'V1'},
                                 ADNI_OLD={'T1': 'V1', 'AV45': 'V1', 'FDG': 'V1', 'FMRI': 'V1', 'AV1451': 'V1'},
                                 DIAN={'T1': 'V1', 'PIB': 'V1', 'FDG': 'V1', 'FMRI': 'V1', 'AV1451': 'V1'})

ADNIDownloadRoot = '/data/data02/ADNI_Downloads/ADNI_EMPTY'
DIANDownloadRoot = '/data/data02/sulantha/DIAN_EMPTY'
...
studyDatabaseRootDict = dict(ADNI='/data/data03/Database', ADNI_OLD='/data/data03/Database', DIAN='/data/data02/Database')
