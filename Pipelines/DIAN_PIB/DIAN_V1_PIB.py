...
class DIAN_V1_PIB:
    ...
    def processPET(self, processingItemObj, matchT1Path):
        ...
        self.set_new_param_str('{0}_{1}_Pipeline'.format(processingItemObj.study, processingItemObj.modality),
        ...
        petCMD = "source /opt/minc-1.9.15/minc-toolkit-config.sh; Pipelines/DIAN_PIB/DIAN_V1_PIB_Process {0} {1} {2} {3} {4} {5} '{6}' {7} {8}".format(
            ...
            'auto' if processingItemObj.manual_xfm == '' else processingItemObj.manual_xfm, logDir, paramStr,
        ...
        QSubJobHandler.submittedJobs[id] = QSubJob(id, '23:00:00', processingItemObj, 'pib')
        return 1
