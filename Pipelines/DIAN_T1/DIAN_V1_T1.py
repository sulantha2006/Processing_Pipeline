...
class DIAN_V1_T1:
    ...
    def runBeast(self, processingItemObj):
        ...
        beastCMD = 'source /opt/minc-1.9.15/minc-toolkit-config.sh; Pipelines/DIAN_T1/DIAN_V1_T1_BeAST {0} {1} {2} {3} {4} {5}'.format(id, nativeFileName, beastFolder, logDir, socket.gethostname(), 50500)
        try:
