...
with open('/data/data03/sulantha/MarinaAnalysis/AV45_list_with_dates.csv', 'r') as file:
    ...
    for line in file:
        ...
        if len(resv1) is 0:
            ...
            for result in resv1:
                if result[12] == 1:
                    v1Path_t = '{0}/processed/final/*tal_nlin_pbavg_ref_cerGM_wmnorm_085.mnc'.format(result[8])
        ...
        if len(resv2) is 0:
            ...
            if resv2[0][12] == 1:
                v2Path = '{0}/processed/final/*tal_nlin_pbavg_ref_cerGM_wmnorm_085.mnc'.format(resv2[0][8])
            ...
            for result in resv2:
                if result[12] == 1:
                    v2Path_t = '{0}/processed/final/*tal_nlin_pbavg_ref_cerGM_wmnorm_085.mnc'.format(result[8])
...
thefile = open('/data/data03/sulantha/MarinaAnalysis/AV45_list_newProcessed.csv', 'w')
